...
static void
bind_array_resize (bind_array_t *bindarr, size_t index)
{
  size_t len = bindarr->len;
  bindarr->array = (bind_item_t*) reallocarray (bindarr->array,
						sizeof (bind_item_t),
...
static void
bind_array_free(bind_array_t *bindarr)
{
...
static void
bind_array_set (bind_array_t *bindarr, size_t index, bind_item_t value)
{
...
static bind_item_t
bind_array_get (bind_array_t *bindarr, size_t index)
{
  if (index >= bindarr->len)
